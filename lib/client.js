...
function MemoirPanel({ controller, api, cwdTracker, t, openSource }) {
...
// src/client/panel-activation.ts
var MEMOIR_ACTIVE_ATTR = "data-dsh-memoir-active";
var PANEL_ACTIVATE_EVENT = "dsh-panel-activate";
var MEMOIR_PANEL_NAME = "memoir";
var SIBLING_ATTRS = ["data-dsh-ssh-active", "data-dsh-taskboard-active"];
function bindPanelActivation(controller, target = document) {
  const applyActive = () => {
...
function mountPanel(controller, api, cwdTracker, t, openSource) {
  let root;
  let container;
  const ensure = () => {
    if (container !== void 0) {
    ...
    root.render(/* @__PURE__ */ (0, import_jsx_runtime2.jsx)(MemoirPanel, { controller, api, cwdTracker, t, openSource }));
  };
  const waitObserver = new MutationObserver(() => {
    ensure();
  });
...
function SettingsSlotCard({ api, t }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("li", { className: `memoir-settings-slot${open ? " memoir-settings-slot-open" : ""}`, "data-dsh-plugin": "memoir", "data-dsh-part": "settings-card", children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { className: "memoir-settings-slot-headtext", children: [
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "memoir-settings-slot-name", title: t("settings.title"), children: t("settings.title") }),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "memoir-settings-slot-description", title: t("settings.description"), children: t("settings.description") })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("svg", { className: `memoir-settings-slot-chevron${open ? " memoir-settings-slot-chevron-open" : ""}`, width: "14", height: "14", viewBox: "0 0 14 14", fill: "none", "aria-hidden": "true", children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "M11.8486 5.5L11.4238 5.92383L8.69727 8.65137C8.44157 8.90706 8.21562 9.13382 8.01172 9.29785C7.79912 9.46883 7.55595 9.61756 7.25 9.66602C7.08435 9.69222 6.91565 9.69222 6.75 9.66602C6.44405 9.61756 6.20088 9.46883 5.98828 9.29785C5.78438 9.13382 5.55843 8.90706 5.30273 8.65137L2.57617 5.92383L2.15137 5.5L3 4.65137L3.42383 5.07617L6.15137 7.80273C6.42595 8.07732 6.59876 8.24849 6.74023 8.3623C6.87291 8.46904 6.92272 8.47813 6.9375 8.48047C6.97895 8.48703 7.02105 8.48703 7.0625 8.48047C7.07728 8.47813 7.12709 8.46904 7.25977 8.3623C7.40124 8.24849 7.57405 8.07732 7.84863 7.80273L10.5762 5.07617L11 4.65137L11.8486 5.5Z", fill: "currentColor" }) })
        ]
      }
    ),
    open ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "memoir-settings-slot-body", children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
      MemoirSettingsPanel,
      {
        api,
        t,
