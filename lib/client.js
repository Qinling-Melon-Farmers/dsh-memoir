...
async function readEnvelope(response) {
  ...
  if (typeof body !== "object" || body === null || body.ok !== true) {
    const message = body && typeof body.error === "object" && body.error !== null && typeof body.error.message === "string" ? body.error.message : `HTTP ${response.status}`;
...
function readCwd(sessions) {
  ...
  const cwd = id === void 0 ? void 0 : snapshot.byId[id] && snapshot.byId[id].cwd;
...
function MemoirPanel({ controller, api, cwdTracker, t }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "memoir-panel", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "memoir-body", children: loading ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "memoir-empty", children: "\u2026" }) : tab === "project" ? cwd === "" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "memoir-empty", children: [
    ...
    ] }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionedEntries, { entries: projectEntries, t, onDelete: (entry) => onDelete(entry, project.path) }) : projects.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "memoir-empty", children: [
