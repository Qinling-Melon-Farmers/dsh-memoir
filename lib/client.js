...
function AutoDistillSettingsPanel({ api, t, refreshKey, onChanged }) {
  ...
  const [every, setEvery] = (0, import_react.useState)("1");
  const [cooldown, setCooldown] = (0, import_react.useState)("0");
  const [minTools, setMinTools] = (0, import_react.useState)("1");
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "memoir-settings", children: [
    ...
    open ? settings === null ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "memoir-settings-body", children: error ?? "\u2026" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "memoir-settings-body", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "memoir-settings-grid", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { className: "memoir-field", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: t("settings.every") }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", { type: "number", min: "1", step: "1", value: every, onChange: (event) => setEvery(event.target.value) }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("small", { children: t("settings.everyHint") })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { className: "memoir-field", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: t("settings.cooldown") }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", { type: "number", min: "0", step: "0.1", value: cooldown, onChange: (event) => setCooldown(event.target.value) }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("small", { children: t("settings.cooldownHint") })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { className: "memoir-field", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: t("settings.minTools") }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", { type: "number", min: "1", step: "1", value: minTools, onChange: (event) => setMinTools(event.target.value) }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("small", { children: t("settings.minToolsHint") })
        ] })
      ] }),
...
function MemoirPanel({ controller, api, cwdTracker, t }) {
  ...
  (0, import_react.useEffect)(() => {
    ...
    if (tab === "project") {
      ...
      setLoading(true);
      api.project(cwd, { status: statusFilter }).then((value) => {
      ...
      setLoading(true);
      api.global({ status: statusFilter }).then((value) => {
  ...
  (0, import_react.useEffect)(() => {
    ...
    const timer = setTimeout(() => {
      ...
      api.search({ scope, path: tab === "project" && cwd !== "" ? cwd : void 0, query: q, status: statusFilter }).then((value) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "memoir-panel", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AutoDistillSettingsPanel, { api, t, refreshKey, onChanged: reload }),
