...
export function memoirRecordTool(store, retrieval, languageSource = DEFAULT_MEMOIR_LANGUAGE) {
...
export function memoirUpdateTool(store, languageSource = DEFAULT_MEMOIR_LANGUAGE) {
    const currentLanguage = () => languageFrom(languageSource);
